...
// //         </button>
// //         <div
// //           className={`absolute top-full right-1 mt-2 p-2 bg-white border rounded shadow-lg text-xs ${
// //             showTooltip ? "block" : "hidden"
// //           }`}
// //         >
// //           This is a project of A Healthier Democracy. Visit
// //           <a
...
//           </button>
//           <div
//             className="absolute right-0transform -translate-x-1/2 mt-2 p-2 bg-white border rounded shadow-lg text-xs hidden group-hover:block"
